...
class RoleController {
  ...
  // public retrieveAllRoles = async(req:Request,res:Response,next:NextFunction) => {
  //   try {
  //     const roles: string[] = [] // await this.roleService.roleRetrieveAll({pageNumber:1,pageSize:10})
  //     res.json(this.roleService.roleRetrieve())
  //   } catch (error) {
  //     next(error)
  //   }
  // }
